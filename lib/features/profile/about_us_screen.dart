        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [AppColors.surface, AppColors.surface.withOpacity(0.4), Colors.transparent],
            ),
          ),
        ),
        Positioned(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text('Setting the Standard', style: AppTextStyles.labelMd.copyWith(color: AppColors.onPrimaryContainer)),
              ),
              ...
              ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: AppSpacing.lg, vertical: AppSpacing.md)),
              ),
            ],
          ),
        ),
...
class _OurStorySection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(AppSpacing.marginMobile, AppSpacing.xxl, AppSpacing.marginMobile, 0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Stack(
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('15+ Years', style: AppTextStyles.headlineSm.copyWith(color: AppColors.primary)),
                      Text('of Excellence in Dentistry', style: AppTextStyles.labelMd),
                    ],
                  ),
                ),
              ),
          ...
          Text('Our Story', style: AppTextStyles.headlineLg.copyWith(color: AppColors.primary)),
          const SizedBox(height: AppSpacing.md),
          Text(
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('12,000+', style: AppTextStyles.headlineMd.copyWith(color: AppColors.secondary)),
                    Text('Happy Smiles Created', style: AppTextStyles.bodySm),
                  ],
                ),
              ),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('98%', style: AppTextStyles.headlineMd.copyWith(color: AppColors.secondary)),
                    Text('Patient Satisfaction', style: AppTextStyles.bodySm),
                  ],
                ),
              ),
            ],
...
class _CoreValuesSection extends StatelessWidget {
  ...
  static const _values = [
    (Icons.verified, 'Excellence', 'We strive for perfection in every procedure, utilizing the highest medical standards.'),
    (Icons.favorite, 'Compassion', 'Care that understands. We prioritize your comfort and peace of mind above all else.'),
    (Icons.lightbulb, 'Innovation', 'Constantly evolving with the latest digital dentistry tools and methodologies.'),
    (Icons.gavel, 'Integrity', 'Transparent communication and honest treatment plans you can trust implicitly.'),
  ];
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.symmetric(horizontal: AppSpacing.marginMobile, vertical: AppSpacing.xxl),
      child: Column(
        children: [
          Text('Our Core Values', style: AppTextStyles.headlineLg.copyWith(color: AppColors.primary), textAlign: TextAlign.center),
          const SizedBox(height: AppSpacing.sm),
          Text(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(v.$1, color: AppColors.onSecondaryContainer),
                        ),
                        const SizedBox(height: AppSpacing.sm),
                        Text(v.$2, style: AppTextStyles.headlineSm.copyWith(color: AppColors.primary, fontSize: 16)),
                        const SizedBox(height: 4),
                        Text(v.$3, style: AppTextStyles.bodySm, maxLines: 4, overflow: TextOverflow.ellipsis),
                      ],
                    ),
                  ),
                )
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.precision_manufacturing, size: 18, color: AppColors.secondary),
              const SizedBox(width: AppSpacing.xs),
              Text('Future-Ready Dentistry', style: AppTextStyles.labelMd.copyWith(color: AppColors.secondary)),
            ],
          ),
          const SizedBox(height: AppSpacing.sm),
          Text('State-of-the-Art Technology', style: AppTextStyles.headlineLg.copyWith(color: AppColors.primary, fontSize: 24)),
          const SizedBox(height: AppSpacing.sm),
          Text(
          ...
          const _TechListItem(
            ...
            description: 'Precise imaging for complex implant and surgical planning.',
          ),
          const SizedBox(height: AppSpacing.md),
          const _TechListItem(
            title: 'Digital Intraoral Scanners',
            description: 'No more messy molds — just comfortable, high-precision digital impressions.',
          ),
        ],
      ),
    );
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(title, style: AppTextStyles.labelMd.copyWith(color: AppColors.primary, fontSize: 13)),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Meet Our Leadership', style: AppTextStyles.headlineLg.copyWith(color: AppColors.primary, fontSize: 24)),
          const SizedBox(height: AppSpacing.sm),
          Text(
          ...
          for (final member in _team) ...[
            Row(
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(AppRadius.xxl),
                  child: Image.network(member.$3, width: 88, height: 88, fit: BoxFit.cover),
                ),
                const SizedBox(width: AppSpacing.md),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(member.$1, style: AppTextStyles.headlineSm.copyWith(color: AppColors.primary)),
                    Text(member.$2.toUpperCase(), style: AppTextStyles.labelMd),
                  ],
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Text('Ready for a Pure Experience?', style: AppTextStyles.headlineMd.copyWith(color: AppColors.primary), textAlign: TextAlign.center),
            const SizedBox(height: AppSpacing.sm),
            Text(
            ...
            OutlinedButton(
              onPressed: () {},
              style: OutlinedButton.styleFrom(minimumSize: const Size.fromHeight(48), side: const BorderSide(color: AppColors.primary, width: 2)),
...
class _ContactFooter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(top: AppSpacing.xxl),
      padding: const EdgeInsets.fromLTRB(AppSpacing.marginMobile, AppSpacing.xl, AppSpacing.marginMobile, AppSpacing.xxl),
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: AppSpacing.lg),
          Text('CONTACT US', style: AppTextStyles.labelMd.copyWith(color: AppColors.primary)),
          const SizedBox(height: AppSpacing.sm),
          Text('123 Clinical Plaza, Medical District\nNew York, NY 10001', style: AppTextStyles.bodySm),
          const SizedBox(height: 4),
          Text('+1 (555) 123-4567', style: AppTextStyles.bodySm),
          const SizedBox(height: AppSpacing.lg),
          Row(
            children: [
              IconButton(onPressed: () {}, icon: const Icon(Icons.public, color: AppColors.onSurfaceVariant)),
              IconButton(onPressed: () {}, icon: const Icon(Icons.share, color: AppColors.onSurfaceVariant)),
            ],
          ),
          Text('© 2024 PureDent Dental Clinic. All rights reserved.', style: AppTextStyles.bodySm),
        ],
      ),
    );
  }
